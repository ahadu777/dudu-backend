...
export class ReservationSlotController {
  ...
  async createSlot(req: Request, res: Response): Promise<void> {
    try {
      ...
      const slot = await this.service.createSlot(request);
  ...
  async updateSlot(req: Request, res: Response): Promise<void> {
    try {
      ...
      const slot = await this.service.updateSlot(slot_id, request);
  ...
  async deleteSlot(req: Request, res: Response): Promise<void> {
    try {
      ...
      const result = await this.service.deleteSlot(slot_id);
  ...
  async getSlots(req: Request, res: Response): Promise<void> {
    try {
      ...
      const slots = await this.service.getSlots(query);
   ...
   * Get available slots for customer view
   */
