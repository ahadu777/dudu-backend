...
deprecated_by: "venue-enhanced-scanning.md"
deprecation_reason: "reports 模块已移除。核销记录功能移至 /venue/redemptions"
---

> ⚠️ **DEPRECATED**: `/reports/redemptions` 端点已不存在。
> reports 模块已移除，功能已迁移至 venue 模块：
> - 使用: `GET /venue/redemptions`
