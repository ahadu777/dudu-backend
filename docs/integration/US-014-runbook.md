...
- [x] **TC-WX-301**: 同一微信账号多次登录
  - 操作: 使用相同微信账号在不同设备登录
  - **Expected**: 每个微信用户只有一个系统账号，用户数据在所有设备同步
  - **Result**: ✅ 通过 (2025-12-20) - 数据同步正常
